							...
							<div class="div6-cadastro-green">
									...
									<div class="div-text-cadastro-lh4">';
										...
										if($qntAnunciosCadastrados > 0) {
 											$valorPlano = 0;
 											echo '<span class="text-cadastro-lh4">'.Utils::formataValorView($valorPlano).'</span>';	
										}
										else {
...
<div class="embarcacoes-form-content">
			...
			<div class="box-cadastro-4">
				...
				<div class="quadro-box-cadastro-4c">
						...
						<div class="select-form-cadastrar2">
								<?php echo $form->dropDownList($model,'ano', $anos,array('class'=>'select-anuncio-pad'))?>
						</div>	
				...
				<?php
						...
						echo '<div class="quadro-box-cadastro-4d">
						<div class="div-cadastro-green">
								...
								echo '<section class="section-duvida-form">
									...
									<section class="none-duvidas">
										<article class="article-duvida">
											Qual o valor que deseseja vender sua embarcação?
										</article>
			...
			echo '<div class="line-cadastro-6 hidden-depende-modelo" style="display:none">
					<div class="container">
						<div class="box-cadastro-6">
							<div class="quadro-box-cadastro-6b" style="width:340px">
							...
							<div class="quadro-box-cadastro-6c" style="width:300px">
								<div class="div-cadastro-green">
									<span class="text-cadastro-green">Boca:</span>	
									<div class="campo-form-cadastro2" style="margin-left: 36px">';
							...
							<div class="quadro-box-cadastro-6a" style="border:solid 0px">
								<div class="div-cadastro-green">
									<span class="text-cadastro-green2">Calado:</span>	
							...
							<div class="quadro-box-cadastro-6a">
								<div class="div-cadastro-green">
									<span class="text-cadastro-green2">Pé Direito:</span>	
							...
							<div class="quadro-box-cadastro-6a" >
								<div class="div-cadastro-green" >
									<span class="text-cadastro-green2">Tanque <br>Água:</span>	
									<div class="campo-form-cadastro2" style="margin-left: 27px">';
							...
							<div class="quadro-box-cadastro-6a">
								<div class="div-cadastro-green">
									<span class="text-cadastro-green">Tamanho*:</span>	
									<div class="campo-form-cadastro2" style="margin-left: 4px">';
							...
							<div class="quadro-box-cadastro-6a">
								<div class="div-cadastro-green">
									<span class="text-cadastro-green2">Tanque<br> Combustível:</span>	
							...
							<div class="quadro-box-cadastro-6a">
								<div class="div-cadastro-green">
									<span class="text-cadastro-green2">Peso<br> Casco:</span>	
								<div class="campo-form-cadastro2" style="margin-left: -7px;">';
			...
			<div class="container">
				<div class="box-cadastro-10">
					...
					<div class="quadro-box-cadastro-10b">
						<span class="text-featured2">Imagem principal</span>
						<div class="line-box-cadastro-10">

							<?php
								// estaleiro tem mais fotos
								if($flgEstaleiro) {
									for($i = 0; $i < Anuncio::$_max_fotos['MAX_FOTOS_ESTALEIRO']; $i++) {
										echo '<div class="div-img quadro-box-cadastro-10c count-'.$i.'">';
											echo '<span style="color: red;display:none; margin-left:17px; font-size:13px !important;" class="error-foto text2-blue-cadastro-l10">Máx 1Mb</span>';
											//echo '<icon class="icone-foto-cadastro2"></i>';
											echo '<img class="img-upload img-preview icone-foto-cadastro2"></img>';
											echo CHtml::fileField('Embarcacoes[foto][]', null, array('class'=>'hide'));
											echo '<div class="div-text2-blue-cadastro-l10">';
												echo '<span class="text2-blue-cadastro-l10">Adicionar foto</span>';
											echo '</div>';
										echo '</div>';
									}								
								}
									...
									for($i = 0; $i < Anuncio::$_max_fotos['MAX_FOTOS_EMBARCACAO']; $i++) {
										echo '<div class="img-upload div-img quadro-box-cadastro-10c count-'.$i.'">';
										echo '<span style="color: red; display:none; margin-left:17px; font-size:13px !important;" class="error-foto text2-blue-cadastro-l10">Máx 1Mb</span>';
											//echo '<icon class="icone-foto-cadastro2"></i>';
											echo '<img id="'.$i.'" class="img-upload img-preview icone-foto-cadastro2"></img>';
											echo CHtml::fileField('Embarcacoes[foto][]', null, array('class'=>'hide'));
											echo '<div class="div-text2-blue-cadastro-l10">';
												echo '<span class="text2-blue-cadastro-l10">Adicionar foto</span>';
											echo '</div>';
								...
								<div class="container">
									<div class="box-cadastro-13">
										...
										echo '<div class="quadro-box-cadastro-13c">';
											echo'<div class="line-box-cadastro-13" style="display:none;" id="div-turbo-fotos">';
								...
								<div class="div-text-cadastro-white-3">
									<span class="text-white-cadastro-3" id="valor-total">
										<?php
											...
											echo Utils::formataValorView($valorPlano);
										?>
									</span>
								</div>
							</div>	
	...
	<!-- Lightbox - Ok - Precisa colocar as validações
		...
		<div class="lbox-form" id="lbox-revise">	
			<div class="texts-lbox-ag">	
				...
				<input type="button" name="botao-finalizar" class="botao-lb-form-anun2" value="FINALIZAR">
		</div>
...
<?php
	$valor;
	if(Yii::app()->request->getParam('valor') == null) {
		$valor = 0;
	}
	else {
		if($qntAnunciosCadastrados > 0) {
