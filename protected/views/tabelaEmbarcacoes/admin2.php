...
// http://codespate.com/2016/06/28/populate-x-editable-select-remote-data-using-separate-ajax-call/
echo '<br/><br/><h1 class="title-admin-form" style="margin-left:35px;">Cadastrar Embarcacão na Tabela</h1>';

echo '<div id="limita" style="margin-top:80px;">';
