<section class="content">
	<div class="line-videos-1">
	 	<div class="container">	
 			<div>	
				<h1 class="title-vid-1">Raio X</h1>
	...
	<div class="line-videos-2" >
		<div class="container">			
				...
				<ul class="options-category-video">
					...
					<li class="tab speedboat-vid active <?php if($array_params['macro'] == 'lancha') echo 'active'; ?>"><a href="#">Lanchas</a></li>
