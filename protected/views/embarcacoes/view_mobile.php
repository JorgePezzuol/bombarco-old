...
<section class="content" id="alterada-sm">
                ...
                <div class="quadro-l1-deemb3 pure-u-1">
                    ...
                    <div class="quadro-l1-deemb2">
                        ...
                        <div class="redes pure-u-3-12 pure-u-sm-12-12 pure-u-md-12-12"> 
                            <a class="btn-rede ax-track-event" data-ax-trackname="detalhe btn comparar" href="<?php echo Yii::app()->createUrl('comparador/comparar', array('id_embarcacao' => $model->id)); ?>" id="botao-deemb1" title="Comparar"><i class="fa fa-exchange"></i></a>
                            <a class="btn-rede ax-track-event" data-ax-trackname="detalhe btn compartilhar" id="compartilhar" target="_blank" title="Compartilhar no Facebook!"><i class="fa fa-facebook"></i></a>
                            ...
                            <div id="transporte" class="tab">
                                <div class="quadro-l3-deemb3">
                                    ...
                                    <div class="consorcio" id="">
                                        <span class="sub-detail">Campos obrigatórios*</span>
                                        <div class="quadro-l3-deemb3b">
                                            <!--<a href="https://www.bombarco.com.br/transporte-de-lancha-veleiro-jetski" target="_blank"><img src="<?php //echo Yii::app()->createUrl('img/LOGO_CSC.jpg'); ?>" alt="Transporte"></a>-->
                                        </div>
                                        <div class="quadro-l3-deemb3c" style="width:100% !important;">
                                            <div class="div-title-bloco3-l3-deemb">
                                                ...
                                                <br>
                                                <span class="sub-title">Comprar ou vender uma embarcação também demanda se preparar para o transporte dela e, consequentemente, os seus custos. Para isso, é necessário uma transportadora especialista no assunto.</span>
                                            </div>
                                        </div>
                                        <div class="texts-lbox-ag">
                                            <!--img src="< ?php echo Yii::app()->createUrl('img/logo-unifisa.png'); ?>" alt="Unifisa"-->
                                            <p>Todo o suporte necessário para transportar sua lancha</p>
                                        </div>
                                        <form id="form_trans" action="<?php echo Yii::app()->createUrl('contatos/partners'); ?>" method="POST" class="data-ax-form">
                                            <div class="form-nome-ag">
                        ...
                        <?php if ($model->status == Embarcacoes::ACTIVE): ?>
                            ...
                            <div class="quadro-deemb">
                                ...
                                <div class="campo"> 
                                    ...
                                    <!--<div class="check"><input type="checkbox" id="partner_finan_principal" value="1" data-form="form_finan" class="checkbox_partners"> Financiamento</div>-->
                                    ...
                                    <div data-form="form_trans" class="check"><input type="checkbox" id="partner_trans_principal" value="1" data-form="form_trans" class="checkbox_partners"> Transporte</div>
                                    <div data-form="form_trans" class="check"><input type="checkbox" value="1" data-form="form_trans"> Arrais amador</div>
                                    <div data-form="form_cons" class="check"><input type="checkbox" id="partner_cons_principal" value="1" data-form="form_cons" class="checkbox_partners"> Consórcio</div>
              ...
              <?php if ($usuarioDonoEmbarc->nome != null && $usuarioDonoEmbarc->nome != ""): ?>
                                    <div class="div-text-bloco2-l2-deemb">
                                        ...
                                        <span class="text-l3-bloco3-deemb verde">
                                            <b><?php echo $usuarioDonoEmbarc->nome ?></b>
                                        </span>
    ...
    <div class="lbox-ag" id="lbox-detemba">
        ...
        <div class="div-pergunta-partners">
            ...
            <div style="margin-bottom: 10px; padding-left: 30px; font-weight: bold;">Consórcio <input type="checkbox" data-form="form_cons" id="partner_cons" class="checkl1 checkbox_partners_lgbox" value="1"></div>
            <div style="margin-bottom: 10px; padding-left: 30px; font-weight: bold;">Arrais amador <input type="checkbox" class="checkl1" value="1"></div>
            ...
            <div style="padding-left: 30px; margin-bottom: 10px; font-weight: bold;">Transporte <input type="checkbox" data-form="form_trans" id="partner_trans" class="checkl1 checkbox_partners_lgbox" value="1"></div>
