...
<section class="content">
	<div class="line-gray-nt-top">
		<div class="container">
			<div>
				...
				<div class="select-form-nt" >								
					<span class="select-int">
						<?php if (isset($array_view['categoria'])): ?>
							<?php echo ConteudoCategorias::dropDown(Conteudos::$categorias_by_slug['blog'], $array_view['categoria']->id); ?>	
						<?php else: ?>
							<?php echo ConteudoCategorias::dropDown(Conteudos::$categorias_by_slug['blog']); ?>
						<?php endif ?>						
					</span>	
				</div>		
				<div class="search-nt">
					<input name="busca" placeholder="Buscar no Blog" class="terms-nt" type="text" value="<?php echo $array_params['busca']; ?>">
					<input type="hidden" value="blog" name="url">
	...
	<div class="line-white-nt">	
		<div class="container" style="min-height: auto !important;" >
						...
						<?php foreach ($blog as $key => $value): ?>
							...
							<?php if ($count == 0): $count++;?>
								...
								<li class="category-nt" style="width: 470px;">
									<a href="<?php echo Conteudos::mountUrl($value, 'blog'); ?>">
										...
										<span class="table-nt2" >
											<span class="texts-nt2" style="position: relative;left: 89px;">
												...
												<span class="text-tipo-nt2"><?php if(isset($value->embarcacaoMacros)) echo $value->embarcacaoMacros->titulo; ?></span>
				...
				<?php if (count($blog) == Conteudos::LIMIT_SEARCH - 1): ?>

				<div class="div-btn-carregar-guia-nt">
					<a class="botao-carregar-guia-nt" id="carregar_nt" data-limit="<?php echo Conteudos::LIMIT_SEARCH; ?>" data-busca="<?php echo $array_params['busca'] ?>" data-categoria="<?php echo $array_params['categoria'] ?>">CARREGAR MAIS</a>	
				</div>	
