		...
		<?php
			for($i = 0; $i < count($model->embarcacaoImagens); $i++) { ?>
				<div class="content-slider swiper-slide">
					<?php  echo '<img class="content-image" src="'.Yii::app()->request->baseUrl.'/public/embarcacoes/'.$model->embarcacaoImagens[$i]->imagem.'" />'; ?>
				</div>
		<?php } ?>	
	</div>
...
<div class="first-infos full-width">
	<div class="container">
		...
		<div class="list-infos full-width">
			...
			<?php endif; ?>
			<?php if($model->embarcacaoModelos->boca != "0.00" && $model->embarcacao_macros_id != 1) : ?>
				<div class="col-info inline-block">
					<span class="title-col">Boca (m): <br /> 
						<span class="content-col"> <?php echo $model->embarcacaoModelos->boca; ?> </span>
					</span>
				</div>
			<?php endif; ?>
			<?php if($model->embarcacaoModelos->calado != "0.00" && $model->embarcacao_macros_id != 1) : ?>
				<div class="col-info inline-block">
					<span class="title-col">Calado (m): <br /> 
						<span class="content-col"> <?php echo $model->embarcacaoModelos->calado; ?> </span>
					</span>
				</div>
			<?php endif; ?>
			<?php if($model->embarcacaoModelos->ncamarotes != "0.00" && $model->embarcacao_macros_id != 1) : ?>
				<div class="col-info inline-block">
					<span class="title-col">Camarotes: <br /> 
						<span class="content-col"> <?php echo $model->embarcacaoModelos->ncamarotes; ?> </span>
					</span>
				</div>
			<?php endif; ?>
			<?php if($model->embarcacaoModelos->nbanheiros != NULL && $model->embarcacao_macros_id != 1) : ?>
				<div class="col-info inline-block">
					<span class="title-col">Banheiros: <br /> 
						<span class="content-col"> <?php echo $model->embarcacaoModelos->nbanheiros; ?> </span>
					</span>
				</div>
			<?php endif; ?>
			<?php if($model->embarcacaoModelos->pesocasco != "0.00" && $model->embarcacao_macros_id != 1) : ?>
				<div class="col-info inline-block">
					<span class="title-col">Peso do casco (Kg): <br /> 
						<span class="content-col"> <?php echo $model->embarcacaoModelos->pesocasco; ?> </span>
					</span>
				</div>
			<?php endif; ?>
			<?php if($model->embarcacaoModelos->pedireito != NULL && $model->embarcacao_macros_id != 1) : ?>
				<div class="col-info inline-block">
					<span class="title-col">Pé direito (m): <br /> 
						<span class="content-col"> <?php echo $model->embarcacaoModelos->pedireito; ?> </span>
					</span>
				</div>
			<?php endif; ?>
			<?php if($model->embarcacaoModelos->tanqueagua != "0.00" && $model->embarcacao_macros_id != 1) : ?>
				<div class="col-info inline-block">
					<span class="title-col">Tanque Água: <br /> 
						<span class="content-col"> <?php echo $model->embarcacaoModelos->tanqueagua . ' L'; ?> </span>
					</span>
				</div>
			<?php endif; ?>
				<?php if($model->embarcacaoModelos->tanquecombustivel != "0.00" && $model->embarcacao_macros_id != 1) : ?>
				<div class="col-info inline-block">
					<span class="title-col">Tanque Ćombustível: <br /> 
						<span class="content-col"> <?php echo $model->embarcacaoModelos->tanquecombustivel. ' L'; ?> </span>
					</span>
				</div>
			<?php endif; ?>
		</div>
	...
	<div class="results-search full-width">
		...
		<div class="container" >
			...
			<?php if ( count($embs_mais_anunciante) == 3 ) : ?>
				<a data-limit="3" id="btn-carregarmais-anunciante" href="#" class="btn-seemore">Carregar Mais</a>
			<?php endif; ?>
...
<div class="single-footer full-width">
	<div class="container">
		<a href="#" class="btn-contato inline-block">Contato</a>
		<div class="btns-footer">
			<a href="#" id="add-favoritos" class="btn-favorito inline-block sprite"></a>
			<a href="#" class="btn-share inline-block sprite"></a>
		</div>
		<div class="box-share">
...
<div class="box-contato box-contato-embarcacoes">
	...
	<div class="header-contato full-width">
		<div class="container">
			<a href="#" class="btn-close-boxcontato inline-block sprite"></a>
	...
	<div class="content-contato full-width">
		<div class="container container-form">
			...
			<?php if (!Yii::app()->user->isGuest): ?>
                <input value="<?php echo Usuarios::getUsuarioLogado()->email; ?>" id="email-contato-anunciante" class="input-text" type="email">
            <?php else: ?>
                <input value="" id="email-contato-anunciante" class="input-text" type="email">
            <?php endif; ?>
