...
<?php $form = $this->beginWidget('GxActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model, 'acessorio_tipos_id'); ?>
		<?php echo $form->dropDownList($model, 'acessorio_tipos_id', GxHtml::listDataEx(AcessorioTipos::model()->findAllAttributes(null, true)), array('prompt' => Yii::t('app', 'All'))); ?>
	</div>
