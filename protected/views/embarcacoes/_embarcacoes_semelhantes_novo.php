...
<div class="line-deemb4">
		<div class="container">
			<div class="box-deemb4 pure-u-1 pure-u-sm-1">
				<div class="box-l2-deemb">
					<div class="div-title-l2-deemb" style="margin-left:0">
						<span class="title-l2-deemb" >Embarcações semelhantes</span>
					</div>
					...
					<div class="clearfix"></div>
						...
						<div id="div-detemba" class="pure-u-4-5 pure-u-sm-1 pure-u-md-1">
								...
								<?php endif; ?>
									...
									<?php
										foreach($embarcacoes_semelhantes as $emb) {
											...
											if(EmbarcacaoImagens::obterImgPrincipal($emb->id) != null) {
