    ...
    <div class="line-det-est-2">
        <div class="container">	
            <h1 class="bloco-esq-deest-l2">	
                ...
                echo CHtml::image($url, $model->nomefantasia, array('width' => '100%', 'height' => 'auto'));
                ?>
            </h1>
            <div class="bloco-dir-deest-l2">			
                <div>	
                    <h1 class="title-l2-deest "><?php echo $model->nomefantasia; ?></h1>
                    <span class="title2-l2-deest"><a class="link-bd" href="<?php echo Yii::app()->createUrl('index.php'); ?>">Home</a> > <a class="link-bd" href="<?php echo Yii::app()->createUrl('estaleiros'); ?>">Estaleiros</a> > <?php echo $model->nomefantasia; ?></span>
                </div>	
                <div class="div-botoes-est-view">
                    ...
                    <?php if (in_array($model->email, Contatos::$emails_estaleiros)): ?>
                        <div class="div-ver-telefone-deest" style="z-index:2 !important;">
                            <a class="botao-ver-lefone-l2-deest vertelefone" id="btn-seguro-detemba" onclick="_gaq.push(['_trackEvent', 'guia-de-empresas', 'click', 'ver_Telefone']);">Ver Telefone</a>
                        </div>
                    <?php endif; ?>


                    <?php if ($model->fanpage != ""): ?>
...
<div class="line-det-est-3">
    <div class="container">	
        <div class="bloco-esq-deest-l3">		
            ...
            <h4 class="text-bloco-esq-l3-deest"><?php echo $model->endereco . ' ' . $model->bairro . ' nº ' . $model->numero . ' - ' . $model->cep . ' ' . $model->cidades->nome . ' ' . $model->estados->nome; ?></h4>
    ...
    <div class="line-det-est-4">
        <div class="container">	
            <div class="div-title-l4-deest">
                <span class="title-l4-deest">Embarcações deste fabricante</span>
            </div>
                            ...
                            <div class="box-unit-emba">	
                                <ul class="categories-emba">
                                    <li class="category-emba">
                                        <?php echo Embarcacoes::getThumb($value, array('class' => 'bg-img-emba'), true); ?>				
                                    </li>			 					
                                </ul>
                                <div class="textos-emba2">
                                    ...
                                    <h2 class="text-deemb-price" style="font-size:15px !important;"> 
                                        ...
                                        if ($value->valor == '0.00' || $value->valor == "") {
                                            ...
                                            echo 'R$ ' . Utils::formataValorView($value->valor);
                                        }
                                        ?>
...
?>
                <input placeholder="Seu nome" value="<?php echo $nome; ?>" id="nome-contato-anunciante" class="terms-ag-1" type="text">
            </div>
            <div class="form-nome-ag-2">

                <input placeholder="Seu e-mail" value="<?php echo $email; ?>" id="email-contato-anunciante" class="terms-ag-2" type="text">
            </div>
            <div class="form-nome-ag-3">
                <input placeholder="Telefone" value="<?php echo $telefone; ?>" id="telefone-contato-anunciante" class="terms-ag-3" type="text">
            </div>
            ...
            <input type="button" id="close-form" class="fechar-form-b close" value="X">
        ...
        <div class="lbox-msgenviada" id="lbox-msgok">	
            ...
            <input type="button" name="botao-revisar" id="btn-close" class="botao-lb-form-msgok close" value="Ok">
        </div>
