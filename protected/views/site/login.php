                    ...
                    <div class="texts-lbox-ag">	
                        <div class="div-title-form-msgok" style="top:0;">
                            ...
                            <div class="search-idt" style="margin-top:10px;">
                                <?php
                                    $email_cookie = Yii::app()->request->cookies->contains('email') ? Yii::app()->request->cookies['email']->value : "";
                                ?>	
                                <input value="<?php echo $email_cookie; ?>" name="esqeceu-senha-email" id="esqeceu-senha-email" class="terms-idtf lembrar-email-input" placeholder="Seu email" type="text">
                            </div>
