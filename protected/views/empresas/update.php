...
Yii::app()->getClientScript()->registerScriptFile(Yii::app()->baseUrl . '/js/update_empresa.js?asd', CClientScript::POS_END);
    ...
    <div class="container">
        ...
        <div class="box-info-3-3">
            ...
            <h1 class="title-box-info bot-border">
                Alteração de dados - <?php echo $empresa->nomefantasia; ?>
            ...
            <div class="info-dados">
                ...
                <div class="input-box-1-3">
                    ...
                    <?php echo $form->textField($empresa, 'nomefantasia', array('maxlength' => 150, 'class' => 'info-input')); ?>
                ...
                <br class="clr">
                <?php if (isset($empresa->planoUsuarios) && isset($empresa->planoUsuarios->planos) && $empresa->planoUsuarios->planos->gratuito == 0): ?>
                    ...
                    <div class="input-box-1-3">
                        ...
                        <?php echo $form->numberField($empresa, 'numero', array('class' => 'info-input')); ?>
                    ...
                    <div class="input-box-1-3">
                        ...
                        <?php echo $form->textField($empresa, 'complemento', array('maxlength' => 100, 'class' => 'info-input')); ?>
                    ...
                    <span class="info-text">Formatos aceitos: JPEG / PNG . Tamanho Máximo 1 MB - Prefira Imagens na horizontal</span>
                    <br class="clr">
                    <div class="input-box-1-3">
                    ...
                    <?php if ($empresa->planoUsuarios->planos->gratuito == 0): ?>
                        <div class="input-box-1-3">
                    ...
                    <?php if (Empresas::checkTurboNaoPago($empresa, 'telefone') && $empresa->planoUsuarios->planos->gratuito == 0): ?>
                        <div class="input-box-1-3">
                    ...
                    <?php if (Empresas::checkTurboNaoPago($empresa, 'video') && $empresa->planoUsuarios->planos->gratuito == 0): ?>
                        <div class="input-box-2-3">
                    ...
                    <?php if ($empresa->macros_id == 2 && $empresa->planoUsuarios->planos->gratuito == 0): ?>
                        ...
                        <?php if (Empresas::checkTurbo($empresa, 'descricao') && $empresa->planoUsuarios->planos->gratuito == 0): ?>
                    ...
                    <?php if ($empresa->macros_id == 3 && $empresa->planoUsuarios->planos->gratuito == 0): ?>
                        <div class="input-box-3-3">
                            <span class="info-label">Descrição (Máx 1000 caractéres):</span>
                            <?php echo $form->textArea($empresa, 'descricao', array('maxlength' => 1000, 'class' => 'info-textarea'));
                            ?>
                    ...
                    <?php if (Empresas::checkTurbo($empresa, 'fotos')): ?>

                        <div id="fotos-turbinadas">

                            <h3 class="title-box-info">Imagens</h3>
                            <div class="input-box-3-3">
                                <p>Formatos Aceitos: JPEG, PNG. Tamanho Máximo: 1mb</p>
                                <?php
