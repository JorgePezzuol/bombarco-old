...
<script src="<?php echo Yii::app()->baseUrl . '/js/conteudos.js?333';?>"></script>
<style>
.ui-datepicker {
    width: 216px;
    height: auto;
				...
				<br/>
						...
						<div class="box-admin-form" style="border-bottom: none !important; text-align:center;">
							...
							<?php echo CHtml::image(Yii::app()->request->baseUrl.'/public/conteudos/'.$conteudoImagem->imagem, 'Imagem da noticia', array('id'=>'imagem-noticia', 'width'=>'250px', 'height'=>'170px')); ?>
								<input type="hidden" id="conteudo_imagem_id" name="conteudo_imagem_id" value="<?php echo $conteudoImagem->id; ?>"/>
								<input type="hidden" id="conteudos_id" name="conteudos_id" value="<?php echo $model->id; ?>"/>
							<?php else:?>
								<!-- id da imagem -->
				...
				<div class="linha-admin-form" style="text-align:center;">
					<div class="container">
						<?php /* ?>
							...
							?>
						<?php
						echo GxHtml::submitButton(Yii::t('app', 'ALTERAR'), array('class'=>'botao-cad-admin', 'id'=>'btn-cadastrar'));
						$this->endWidget();
						?>
					</div>
				</div>
