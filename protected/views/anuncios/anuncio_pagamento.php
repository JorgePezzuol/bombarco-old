...
<section class="content">
        ...
        <div class="container">
            <div class="box-cadastro-1">
                ...
                if(Usuarios::hasPlanoAnuncio()) {
                    echo '<a class="botao-pag-1" href="anunciarEmbarcacao?tipo_anuncio=plano" id="btn-pagamento" onclick="_gaq.push([\'_trackEvent\', \'Pagamento\', \'click\', \'ADICIONAR-ANUNCIO\']);">ADICIONAR ANUNCIO</a>';
                }
                else {
                    echo '<a class="botao-pag-1" href="index" id="btn-pagamento" onclick="_gaq.push([\'_trackEvent\', \'Pagamento\', \'click\', \'ADICIONAR-ANUNCIO\']);">ADICIONAR ANUNCIO</a>';
                }
                
                if($flgOrdensApagar && $somaOrdens != null) {

                    echo '<a class="link-pagamento botao-pag-2" id="btn-pagamento" onclick="_gaq.push([\'_trackEvent\', \'Pagamento\', \'click\', \'EFETUAR-PAGAMENTOS\']);">EFETUAR PAGAMENTOS</a>';
                }
    ...
    <div class="container payment_container" style="display:none;" id="novo-pagamento">
        ...
        <div class="pure-g" id="ordem">

            <?php /* ?>
            <div class="pure-u-1-4">
                <label for="option_payment_boleto" class="option-boleto">
                <input type="radio" id="option_payment_boleto" class="option_payment" name="option_payment" value="2"  /> Boleto
                <?php echo CHtml::image(Yii::app()->baseUrl.'/img/u145.png', '', array('width'=>50)); ?>
                </label>
            </div>
            <?php */ ?>

            <div class="pure-u-1-4">
                <label for="option_payment_card" class="option-card">
            ...
            <div class="payment-tabs">
                <div class="pure-g">
                    ...
                    <div class="pure-u-1-2 form-card" style="display:block !important;">
