...
<div class="container">
    ...
    <?php if($mostraLink): ?>
      <div class="row mostraLink">
         <div class="alert alert-success">
               <strong>Successo!</strong> Link do contrato para enviar para o cliente: <a target="_blank" id="link-cliente" href="<?php echo Yii::app()->createUrl("admin/contrato/assinar/".$model->slug);?>">Link do contrato</a>
         </div>
      </div>
    <?php endif; ?>
      ...
      <div class="row">
         <div class="form-group">
            ...
            <div class="col-md-2" style="width: 24.666667% !important;">
               <?php echo $form->textField($model, 'cnpj', array("class"=>"cnpj input_line form-control")); ?>
            </div>
         </div>
      </div>
      <br/>
      ...
      <div class="table-responsive">
         <table class="table table-bordered">
            ...
            <tbody>
               <tr>
                  <td>Classificados</td>
                  <td><?php echo $form->textField($model,'plano_classificados_desc', array("class"=>"textarea-td")); ?></td>
                  <td><?php echo $form->textField($model,'plano_classificados_periodo', array("class"=>"textarea-td")); ?></td>
                  <td><?php echo $form->textField($model,'plano_classificado_valor', array("class"=>"moeda textarea-td")); ?></td>
                  <td><?php echo $form->textField($model,'plano_classificados_subtotal', array("class"=>"moeda textarea-td")); ?></td>
               </tr>
               <tr>
                  <td>Banner no site Bombarco</td>
                  <td><?php echo $form->textField($model,'plano_banner_site_bb_desc', array("class"=>"textarea-td")); ?></td>
                  <td><?php echo $form->textField($model,'plano_banner_site_bb_periodo', array("class"=>"textarea-td")); ?></td>
                  <td><?php echo $form->textField($model,'plano_banner_site_bb_valor', array("class"=>"moeda textarea-td")); ?></td>
                  <td><?php echo $form->textField($model,'plano_banner_site_bb_subtotal', array("class"=>"moeda textarea-td")); ?></td>
               </tr>
               <tr>
                  <td>Banner na News</td>
                  <td><?php echo $form->textField($model,'plano_banner_news_desc', array("class"=>"textarea-td")); ?></td>
                  <td><?php echo $form->textField($model,'plano_banner_news_periodo', array("class"=>"textarea-td")); ?></td>
                  <td><?php echo $form->textField($model,'plano_banner_news_valor', array("class"=>"moeda textarea-td")); ?></td>
                  <td><?php echo $form->textField($model,'plano_banner_news_subtotal', array("class"=>"moeda textarea-td")); ?></td>
               </tr>
               <tr>
                  <td>E-mail Marketing</td>
                  <td><?php echo $form->textField($model,'plano_emkt_desc', array("class"=>"textarea-td")); ?></td>
                  <td><?php echo $form->textField($model,'plano_emkt_periodo', array("class"=>"textarea-td")); ?></td>
                  <td><?php echo $form->textField($model,'plano_emkt_valor', array("class"=>"moeda textarea-td")); ?></td>
                  <td><?php echo $form->textField($model,'plano_emkt_subtotal', array("class"=>"moeda textarea-td")); ?></td>
               </tr>
               <tr>
                  <td>Zero Milhas</td>
                  <td><?php echo $form->textField($model,'plano_zeromilhas_desc', array("class"=>"textarea-td")); ?></td>
                  <td><?php echo $form->textField($model,'plano_zeromilhas_periodo', array("class"=>"textarea-td")); ?></td>
                  <td><?php echo $form->textField($model,'plano_zeromilhas_valor', array("class"=>"moeda textarea-td")); ?></td>
                  <td><?php echo $form->textField($model,'plano_zeromilhas_subtotal', array("class"=>"moeda textarea-td")); ?></td>
               </tr>
               <tr>
                  <td>Impresso - Guia do Capitão</td>
                  <td><?php echo $form->textField($model,'plano_impresso_guia_desc', array("class"=>"textarea-td")); ?></td>
                  <td><?php echo $form->textField($model,'plano_impresso_guia_periodo', array("class"=>"textarea-td")); ?></td>
                  <td><?php echo $form->textField($model,'plano_impresso_guia_valor', array("class"=>"moeda textarea-td")); ?></td>
                  <td><?php echo $form->textField($model,'plano_impresso_guia_subtotal', array("class"=>"moeda textarea-td")); ?></td>
               </tr>
               <tr>
                  <td>Site - Guia do Capitão</td>
                  <td><?php echo $form->textField($model,'plano_site_guia_desc', array("class"=>"textarea-td")); ?></td>
                  <td><?php echo $form->textField($model,'plano_site_guia_periodo', array("class"=>"textarea-td")); ?></td>
                  <td><?php echo $form->textField($model,'plano_site_guia_valor', array("class"=>"moeda textarea-td")); ?></td>
                  <td><?php echo $form->textField($model,'plano_site_guia_subtotal', array("class"=>"moeda textarea-td")); ?></td>
               </tr>
               <tr>
                  <td>Raio X</td>
                  <td><?php echo $form->textField($model,'plano_raiox_desc', array("class"=>"textarea-td")); ?></td>
                  <td><?php echo $form->textField($model,'plano_raiox_periodo', array("class"=>"textarea-td")); ?></td>
                  <td><?php echo $form->textField($model,'plano_raiox_valor', array("class"=>"moeda textarea-td")); ?></td>
                  <td><?php echo $form->textField($model,'plano_raiox_subtotal', array("class"=>"moeda textarea-td")); ?></td>
               </tr>
               <tr>
                  <td>Outros</td>
                  <td><?php echo $form->textField($model,'plano_outros_desc', array("class"=>"textarea-td")); ?></td>
                  <td><?php echo $form->textField($model,'plano_outros_periodo', array("class"=>"textarea-td")); ?></td>
                  <td><?php echo $form->textField($model,'plano_outros_valor', array("class"=>"moeda textarea-td")); ?></td>
                  <td><?php echo $form->textField($model,'plano_outros_subtotal', array("class"=>"moeda textarea-td")); ?></td>
               </tr>
            </tbody>
         </table>
      </div>
   ...
   <div class="row" id="texto-contrato">
   ...
   <?php echo $form->hiddenField($model,'segundo_visto_bombarco', array("id"=>"visto_bombarco_hidden2")); ?>
   ...
   $(document).ready(function() {
     ...
     $("#texto-contrato").hide();
      ...
      $("#btn-assinar").on("click", function(e) {
            ...
            tipo = $("#visto_bombarco2").jSignature("getData","svgbase64")[0];
            assinatura = $("#visto_bombarco2").jSignature("getData","svgbase64")[1];
            tipo = "data:"+tipo+",";
            var base64_visto_bombarco2 = tipo+assinatura;

            $("#visto_bombarco_hidden").val(base64_visto_bombarco);
            //$("#visto_contratante_hidden").val(base64_visto_contratante);
            $("#visto_bombarco_hidden2").val(base64_visto_bombarco2);
            //$("#visto_contratante_hidden2").val(base64_visto_contratante2);
            // fim assianturas e vistos

            if( $("#visto_bombarco2").jSignature('getData', 'native').length == 0 || 
               $("#visto_bombarco").jSignature('getData', 'native').length == 0) {
                $.alert({
                    title: 'Erro',
                    content: 'Por favor de os 2 vistos no contrato antes de enviar para o cliente',
                });
                return false;
            }
