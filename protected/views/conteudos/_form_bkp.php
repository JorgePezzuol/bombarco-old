					...
					<div class="container">
						<div class="box-admin-form">
							...
							<div class="embarcacao_macros_id">				
								<?php echo $form->dropDownList($model, 'macro', array(''=>'Selecione','B'=>'Blog', 'N'=>'Notícias', 'P'=>'Primeiro Barco', 'T'=>'Teste BomBarco'), array('class'=>'select-anuncio-pad', 'id'=>'macro_conteudo')); ?>
							</div>
