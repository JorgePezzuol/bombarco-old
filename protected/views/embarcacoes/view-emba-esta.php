<?php
	Yii::app()->getClientScript()->registerScriptFile(Yii::app()->baseUrl . '/js/contato.js?'.microtime(), CClientScript::POS_END);
	...
	Yii::app()->getClientScript()->registerScriptFile(Yii::app()->baseUrl . '/js/embarcacoes_detalhe.js?'.microtime(), CClientScript::POS_END);
...
<title><?php echo "Bombarco | ".$fabricante . " - ".$modelo;?></title>
...
<section class="content estaleiro-embarcacao">
					...
					<!-- botao de contato -->
					 ...
					 <?php if ($model->status == Embarcacoes::ACTIVE): ?>
	                    ...
	                    <div class="quadro-l1-deemb8">
							<a class="botao-deemb-contato btn-lbox" data-lbox="#lbox-detemba" id="btn-contato-detemba" >ENTRE EM CONTATO</a>
	...
	<div class="container">
		...
		<div class="quadro-l3-deemb3 emba-esta">
	        <div class="quadro-l3-deemb3b">
	            <a href="http://www.bombarco.com.br/consorcio-lancha-veleiro-jetski" target="_blank"><img src="<?php echo Yii::app()->createUrl('img/logo-unifisa.png'); ?>" alt="Unifisa"></a>
	        </div>
	        ...
	        <div class="quadro-l3-deemb3d">
	            <a class="botao-deemb-4 btn-lbox" data-lbox="#lbox-detemba2" id="btn-seguro-detemba">Fazer cotação</a>
	        </div>
	    </div>
	
	    <!--<div class="quadro-l3-deemb3 emba-esta">
                <div class="quadro-l3-deemb3b">
                    <a href="http://www.bombarco.com.br/financiamento-lancha-veleiro-jetski" target="_blank"><img src="<?php echo Yii::app()->createUrl('img/logo-alfa.png'); ?>" alt="Alfa Financeira"></a>
                </div>
                <div class="quadro-l3-deemb3c">
                    <div class="div-title-bloco3-l3-deemb">
		    ...
		    <div class="quadro-l3-deemb3 emba-esta">
                <div class="quadro-l3-deemb3b" style="width:104px; height:104px;">
                    <!--<a href="http://www.bombarco.com.br/transporte-de-lancha-veleiro-jetski" target="_blank">
                    	<img style="width:104px; height:104px;" src="<?php //echo Yii::app()->createUrl('img/LOGO_CSC.jpg'); ?>" alt="Transporte">
                    </a>-->
                </div>
                <div class="quadro-l3-deemb3c">
                    <div class="div-title-bloco3-l3-deemb">
                        <span class="title-l3-bloco2-deemb">Pensando em transportar seu barco?</span>
                        <br>
                        <span class="sub-title">Nós te ajudamos a transportar o seu barco!</span>
                    </div>
                </div> 
                <div class="quadro-l3-deemb3d">
                    <a class="botao-deemb-4 btn-lbox" data-lbox="#lbox-detemba1" id="btn-financ-detemba">Fazer cotação</a>
                </div>
            </div>
            ...
            <div class="quadro-l3-deemb3 emba-esta">
                ...
                <div class="quadro-l3-deemb3c">
                    <div class="div-title-bloco3-l3-deemb">
                        <span class="title-l3-bloco2-deemb">Veja o preço para deixar o seu barco em uma marina</span>
                        <br>
                        <span class="sub-title">Nós te ajudamos a encontrar uma marina</span>
                    </div>
                </div> 
                <div class="quadro-l3-deemb3d">
                    <a class="botao-deemb-4 btn-lbox2" href="https://www.bombarco.com.br/preco-de-marina" target="_blank">Contatar especialista</a>
                </div>
            </div>
	</div>
    ...
    <div class="lbox-ag" id="lbox-detemba2">
        ...
        <form id="form_cons" action="<?php echo Yii::app()->createUrl('contatos/partners'); ?>" method="POST" class="data-ax-form">
            ...
            <input data-form="form_cons" type="button" name="botao-cadastrar-form" class="botao-cadastrar-form botao_contato_partners" value="ENVIAR PEDIDO" />
    ...
    <div class="lbox-ag" id="lbox-detemba3">
    	...
    	<!-- Lightbox transporte -->
    <div class="lbox-ag" id="lbox-detemba1">
        <div class="texts-lbox-ag">
            <input type="button" id="close" class="fechar-form close" value="X" style="margin-top:5px">
            <!--<img src="<?php echo Yii::app()->createUrl('img/logo-seguro.png'); ?>" alt="Unifisa">-->
            <p>Nós te ajudamos! Leve a sua embarcação com segurança e eficiência</p>
        </div>
        <form id="form_trans" action="<?php echo Yii::app()->createUrl('contatos/partners'); ?>" method="POST">
            <div class="form-nome-ag">
                <input name="trans_nome" placeholder="Seu nome*" id="form-1-ag-lb" class="terms-ag-1" value="<?php echo (!empty($usuario_logado))?$usuario_logado->nome:''; ?>" type="text" required="required">
            </div>
            <div class="form-nome-ag">
                <input name="trans_email" placeholder="Seu e-mail*" class="terms-ag-1" type="email" value="<?php echo (!empty($usuario_logado))?$usuario_logado->email:''; ?>" required="required">
            </div>
            <div class="form-nome-ag">
                <input name="trans_phone" placeholder="Seu telefone*" class="terms-ag-1" type="tel" value="<?php echo (!empty($usuario_logado))?$usuario_logado->celular:''; ?>" required="required">
            </div>
            <span class="sub-detail">Campos obrigatórios*</span>
            <input type="text" name="C7RiUSGm" value="" style="display:none !important;" />
            <input data-form="form_trans" type="button" name="botao-cadastrar-form" class="botao-cadastrar-form botao_contato_partners" value="ENVIAR PEDIDO" />
            ...
            <input type="hidden" name="trans_link" value="<?php echo $_SERVER['HTTP_HOST']."/".Embarcacoes::mountUrl($model); ?>" />
