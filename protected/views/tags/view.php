...
<h2><?php echo GxHtml::encode($model->getRelationLabel('agendases')); ?></h2>
<?php
	echo GxHtml::openTag('ul');
	foreach($model->agendases as $relatedModel) {
		echo GxHtml::openTag('li');
		echo GxHtml::link(GxHtml::encode(GxHtml::valueEx($relatedModel)), array('agendas/view', 'id' => GxActiveRecord::extractPkValue($relatedModel, true)));
		echo GxHtml::closeTag('li');
	}
	echo GxHtml::closeTag('ul');
?><h2><?php echo GxHtml::encode($model->getRelationLabel('conteudoses')); ?></h2>
<?php
	echo GxHtml::openTag('ul');
