...
Yii::import('application.models._base.BaseAppTokens');

class AppTokens extends BaseAppTokens
{
	...
	public static function pushNotification() {
		...
		$content      = array(
        	"en" => 'Olá, tenho interesse neste produto e gostaria de receber mais informações'
        );
        $hashes_array = array();
