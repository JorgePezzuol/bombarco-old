...
class UtilsController extends GxController {
    ...
    public function actionLoadFabricantesEmbarcacoes() {
        ...
        $fabricantes = EmbarcacaoFabricantes::model()->findAll('embarcacao_macros_id=:embarcacao_macros_id AND status=:status', array(':embarcacao_macros_id' => $embarcacao_macros_id, ':status' => $status));
    ...
    public function actionGerarTransacao() {
        ...
        $transacao = Usuarios::getTransacao();
