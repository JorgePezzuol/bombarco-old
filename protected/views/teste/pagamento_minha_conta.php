...
Yii::app()->getClientScript()->registerScriptFile(Yii::app()->baseUrl . '/js/teste.js?8', CClientScript::POS_END);
...
<div class="container payment_container" style="display:none;" id="novo-pagamento">
        ...
        <div class="pure-g">
            ...
            <?php /* ?><div class="pure-u-1-4">
                <label for="option_payment_card" class="option-card active">
                <input type="radio" id="option_payment_card" class="option_payment" name="option_payment" value="1" checked="checked" /> Cartão de Crédito
                <?php echo CHtml::image(Yii::app()->baseUrl.'/img/u143.png'); ?>
                </label>
            </div> 
            <?php */ ?>
            ...
            <div class="payment-tabs">
                ...
                <div class="pure-g">
                    ...
                    <div class="pure-u-1-2 form-boleto">
                        <?php $this->renderPartial('_anuncio_pagamento_boleto'); ?>
                    </div>
                ...
                <div class="pure-g" id="ordem" style="margin-top: 20px;">
                    <!--<div id="transacao-info" style="color:#00918E;" class="text-pag-os"></div>-->
                    <span class="valor text-pag-os" style="color:#00918E !important;" id="transacao-info"></span>
                </div>

                <div class="pure-g" id="concordo" style="margin-top: 20px;">
                    <input type="checkbox" style="margin-top:4px; margin-right:5px;" id="termos-condicao"/> Li e aceito os  <a href="#" class="open-terms" style="margin-left: 5px;">termos de condição</a>.
