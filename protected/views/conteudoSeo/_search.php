...
<?php $form = $this->beginWidget('GxActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model, 'conteudos_id'); ?>
		<?php echo $form->dropDownList($model, 'conteudos_id', GxHtml::listDataEx(Conteudos::model()->findAllAttributes(null, true)), array('prompt' => Yii::t('app', 'All'))); ?>
	</div>
