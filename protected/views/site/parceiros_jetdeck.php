...
<section class="content partner">
		<?php 
			$img = Yii::app()->baseUrl . "/img/jetdeck.jpg";
		?>
			...
			<div class="pure-g">
				...
				<div class="pure-u-5-8">
					...
					<div class="partner-content">
						...
						<img lass="partner-banner" src="<?php echo $img;?>">
				...
				<div class="pure-u-3-8">
					...
					<form id="form_partner" name="form_partner" action="<?php echo Yii::app()->createUrl('contatos/partner'); ?>" method="POST" class="partner-form-wrap">
						...
						<input type="text" name="local_partida" placeholder="Local da embarcação*" class="partner-input" required />
