			...
			<?php if($model->embarcacaoModelos->embarcacaoTipos->titulo != "") : ?>
				<div class="col-info inline-block">
					<span class="title-col">Tipo: <br /> 
						<span class="content-col"> <?php echo $model->embarcacaoModelos->embarcacaoTipos->titulo; ?> </span>
					</span>
				</div>
			<?php endif; ?>
			<?php if($model->estado != "") : ?>
...
<div class="box-contato box-contato-embarcacoes">
	...
	<div class="content-contato full-width">
		<div class="container container-form">
			...
			<input id="nome-contato-anunciante" class="input-text" type="text" />

			<label class="label-contato">Email</label>
			<input id="email-contato-anunciante" class="input-text" type="email" />
