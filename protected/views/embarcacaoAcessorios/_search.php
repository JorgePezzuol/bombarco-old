...
<?php $form = $this->beginWidget('GxActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model, 'acessorios_id'); ?>
		<?php echo $form->dropDownList($model, 'acessorios_id', GxHtml::listDataEx(AcessorioModelos::model()->findAllAttributes(null, true)), array('prompt' => Yii::t('app', 'All'))); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model, 'chave'); ?>
