              ...
              <div class="col-lg-6 col-sm-12">
                 <div class="form-group">
                    ...
                    <span id="span-marca" style="padding: 1em 0 !important;" class="estiliza-select">
                        <?php echo $form->dropDownList($motor,'motor_fabricantes_id', GxHtml::listDataEx(MotorFabricantes::model()->findAllAttributes(null, true, 'status=:status order by titulo asc', array(':status'=>1))), array('prompt'=>'selecione', 'class'=>'required')); ?>
                ...
                <div class="col-lg-6 col-sm-12">
                 <div class="form-group">
                    ...
                    <span id="span-tipo" style="padding: 1em 0 !important;" class="estiliza-select">
                        <?php echo $form->dropDownList($motor,'motor_tipos_id', GxHtml::listDataEx(MotorTipos::model()->findAllAttributes(null, true, 'status=:status order by titulo asc', array(':status'=>1))), array('prompt'=>'selecione', 'class'=>'required')); ?>
                    </span>
                    <br/>
                ...
                <div class="form-group">
                    ...
                    <span style="padding: 1em 0 !important;" class="estiliza-select">
                        <?php echo $form->dropDownList($motor,'estado', array('prompt'=>'selecione', 'N'=>'Novo','U'=>'Usado'), array('class'=>'required')); ?>
                    </span>
                  </div>
          ...
          <div class="col-lg-12 col-sm-12">
              ...
              <div class="col-lg-12 col-sm-12">
                <div class="row">
                  <div class="col-lg-4 col-sm-12">
                    <h4 class="com-barra-abaixo"><b>Insira fotos </b><br/>do seu motor (Máx 6)</h4>
                    <br/><br/>
                    <a href="#" id="apagar-fotos" style="display:none;">Apagar fotos</a>
                  </div>
            ...
            <ul class="lista-fotos" style="column-count: 6" id="fotos">
              <li class="li-img li-img-vazia">
                <a href="#">
                <img class="img-thumbnail" id="img-0" src="<?php echo Yii::app()->baseUrl . '/img_zeromilhas/icones/sem_imagem.png'?>" alt="Espaço para Imagem"/>
              </a>
              </li>
              <li class="li-img li-img-vazia"><a href="#"><img class="img-thumbnail" id="img-1" src="<?php echo Yii::app()->baseUrl . '/img_zeromilhas/icones/sem_imagem.png'?>" alt="Espaço para Imagem"/></a></li>
              <li class="li-img li-img-vazia"><a href="#"><img class="img-thumbnail" id="img-2" src="<?php echo Yii::app()->baseUrl . '/img_zeromilhas/icones/sem_imagem.png'?>" alt="Espaço para Imagem"/></a></li>
              <li class="li-img li-img-vazia"><a href="#"><img class="img-thumbnail" id="img-3" src="<?php echo Yii::app()->baseUrl . '/img_zeromilhas/icones/sem_imagem.png'?>" alt="Espaço para Imagem"/></a></li>
              <li class="li-img li-img-vazia"><a href="#"><img class="img-thumbnail" id="img-4" src="<?php echo Yii::app()->baseUrl . '/img_zeromilhas/icones/sem_imagem.png'?>" alt="Espaço para Imagem"/></a></li>
              <li class="li-img li-img-vazia"><a href="#"><img class="img-thumbnail" id="img-5" src="<?php echo Yii::app()->baseUrl . '/img_zeromilhas/icones/sem_imagem.png'?>" alt="Espaço para Imagem"/></a></li>
            </ul>
          </div>
        </div>
          ...
          <div class="col-lg-12 col-sm-12">
            <div class="row filtros barra-titulo">
              <div class="col-lg-12 col-sm-12">
                <div class="row">
                  <div class="col-lg-12 col-sm-12">
                    <h4 class="com-barra-abaixo">Total a pagar: <b id="valor-total">R$ <?php echo Utils::formataValorView(PlanoUsuarios::model()->findByPk($_GET["pid"])->valor);?></b></h4>
                  </div>
                  <div class="col-lg-8 col-sm-12"></div>
                </div>
              </div>
...
<script>
    $(document).ready(function() {
        ...
        $("#apagar-fotos").on("click", function(e) {
            e.preventDefault();
            $("#apagar-fotos").hide();
            $("#fotos").empty();
            $("#ordem-fotos").val("");
            ...
            for(var i = 0; i < 6; i++) {
                $("#fotos").append('<li class="li-img li-img-vazia"><a href="#"><img class="img-thumbnail" src="/img_zeromilhas/icones/sem_imagem.png" alt="Espaço para Imagem"/></a></li>');
            }
        });
        ...
        $("#btn-publicar").on("click", function(e) {
            ...
            if (validar() == true) {
                ...
                if (s) {
                    $("#motor-anuncio-form").attr("action", "/anunciarMotor?pid=" + pid);
        ...
        function handleFileSelect(evt) {
            ...
            if (files) {
                setTimeout(function() {
                    ...
                    //$(".com-imagem").append("<span class='texto-img-principal btn-apagar-foto' style='color:red !important; font-weight:bolder; cursor:pointer;'>X</span>");
