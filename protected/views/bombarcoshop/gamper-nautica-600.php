      ...
      <section class="slider-ebook">
         ...
         <div class="swiper-container">
            ...
            <div class="swiper-wrapper">
               ...
               <div class="swiper-slide"><img style="top: initial !important; width: 100% !important;" alt="img-banner" class="img-slider" src="http://www.bombarco.com.br/public/embarcacoes/58ff44bea1850Capturar.JPG" /></div>

               <div class="swiper-slide">
                  <img style="top: initial !important; width: 100% !important;" class="img-slider" src="http://www.bombarco.com.br/public/embarcacoes/58ff44bf3ee2fgamper600-2.jpg" />
                </div>

                <div class="swiper-slide">
                  <img style="top: initial !important; width: 100% !important;" class="img-slider" src="http://www.bombarco.com.br/public/embarcacoes/58ff44bf84bc4gamper600-3.jpg" />
                </div>
      ...
      <section class="section-about-the-ebook">
         ...
         <div class="container">
            ...
            <p class="about-ebook-text">
               ...
               Lancha Gamper 600: Produto novo, pego em permuta. As fotos ainda são ilustrativas, o inflável ainda não ficou pronto. É uma oportunidade, porque poderá ser retirado diretamente na fábrica. !!!!!!!!! Entre em contato E FAÇA SUA PROPOSTA!

            </p>

            <div class="wrapper-preco-post-about">

               <div class="col-md-4 left-side-price">por</div>

               <div style="font-size: 2.6rem;" class="col-md-8 right-side-price">R$ 79.000,00</div><small style="font-family: 'Montserrat';
    font-weight: bolder;
    color: #016969;
    font-size: 1.2em;
    ">(somente casco)</small>
      ...
      <section class="section-contents-list">
         ...
         <div class="container">
            ...
            <h2 class="title-contents-list">GAMPER NÁUTICA 600 - 2017, INFLÁVEL  - PREÇO IMBATÍVEL!!</h2>

            <div class="col-md-6 column-contents">

               <ul class="contents-list">

                  <li class="item-list">Bote inflável feito com todo o cuidado e tecnologia</li>

                  <li class="item-list">Tubos feitos de HYPALON, tipo ORCA 828 importado e reconhecido pelas normas Italianas e americanas</li>

                  <li class="item-list">Chicote Elétrico com painel externo de fusíveis</li>

                  <li class="item-list">Painel 6 teclas</li>

                  <li class="item-list">Bateria 60 amperes</li>

                  <li class="item-list">Chave geral PERKO</li>
            ...
            <div class="col-md-6 column-contents">
               ...
               <ul class="contents-list">
                  ...
                  <li class="item-list">Tomada 12V </li>

                  <li class="item-list">Assento rebatível de pilotagem </li>

                  <li class="item-list">Caixa de direção mecânica, com cabo de direção e bezel </li>

                  <li class="item-list">Volante em aço inox com empunhadura em poliuretano</li>

                  <li class="item-list">Bomba de porão 1000 gph com acionamento automático</li>

                  <li class="item-list">Escada de popa em aço inox</li>

                  <li class="item-list">Par de remos</li>
      ...
      <section class="form-cadastro-email">
         ...
         <div class="container">
            ...
            <h3 class="title-form">Entre em contato E FAÇA SUA PROPOSTA</h3>
            ...
            <form id="form-cadastro" 
               ...
               <button id="btn-pagar" type="submit" disabled class="button-comprar-bombarco">Enviar</button>
