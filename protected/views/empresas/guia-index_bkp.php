<section class="content">
    <div class="line-white-guia">
        <div class="container" >	
            ...
            <div class="div-search-ok-4" style="width:290px !important">
                <div class="search-ok-4" style="width:290px !important">
                    <input name="termo" placeholder="Buscar Empresas" class="terms-ok-3" type="text" style="left:-23px;width:233px;">
                    ...
                    <ul class="categories-guia">
                        ...
                        <li class="category-guia">
                            <a href="<?php echo Yii::app()->createUrl('guia-de-empresas/artigos-nauticos-em-geral'); ?>">
                                <img class="bg-img-guia" src="<?php echo Yii::app()->theme->baseUrl; ?>/img/artigosNauticos.png">
                                <span class="table-guia">
                                    <span class="texts-guia">
                        ...
                        <li class="category-guia">
                            <a href="<?php echo Yii::app()->createUrl('guia-de-empresas/despachante'); ?>">
                                <img class="bg-img-guia" src="<?php echo Yii::app()->theme->baseUrl; ?>/img/despachante.png">
                                <span class="table-guia">
                                    <span class="texts-guia">
                        ...
                        <li class="category-guia">
                            <a href="<?php echo Yii::app()->createUrl('guia-de-empresas/marina-e-iate-clube'); ?>">
                                <img class="bg-img-guia" src="<?php echo Yii::app()->theme->baseUrl; ?>/img/marinas.png">
                                <span class="table-guia">
                                    <span class="texts-guia">
                        ...
                        <li class="category-guia">
                            <a href="<?php echo Yii::app()->createUrl('guia-de-empresas/motores'); ?>">
                                <img class="bg-img-guia" src="<?php echo Yii::app()->theme->baseUrl; ?>/img/motores.png">
                                <span class="table-guia">
                                    <span class="texts-guia">
                        ...
                        <li class="category-guia">
                            <a href="<?php echo Yii::app()->createUrl('guia-de-empresas/revendas-e-brokers'); ?>">
                                <img class="bg-img-guia" src="<?php echo Yii::app()->theme->baseUrl; ?>/img/revendas.png">
                                <span class="table-guia">
                                    <span class="texts-guia">
                        ...
                        <ul class="categories-guia-s">
                            <?php foreach ($destaques as $key => $value): ?>
                                ...
                                <li class="category-guia-s" >
                                    <a href="<?php echo $url; ?>">
                                        <?php if (count($value->empresaImagens) > 0): ?>
                                            <img class="img-guia-s" src="<?php echo Yii::app()->baseUrl . '/public/empresas/' . $value->logo; ?>">
                                        <?php else: ?>
                                            <img class="img-guia-s" src="<?php echo Yii::app()->theme->baseUrl; ?>/img/sem_foto_bb.jpg">
                                        <?php endif ?>		
                                    </a>
                                </li>
