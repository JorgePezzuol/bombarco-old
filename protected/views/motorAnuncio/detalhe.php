...
<?php
    ...
    // meta tags
    $principal = MotorAnuncio::obterImgPrincipal($motor);
    if($principal != null) {
        Yii::app()->clientScript->registerMetaTag(Yii::app()->request->baseUrl . '/public/motores/' . $principal, 'og:image:secure_url');    
    }
    Yii::app()->clientScript->registerMetaTag(MotorAnuncio::nomeAnuncio($motor), 'og:title');
    Yii::app()->clientScript->registerMetaTag(Yii::app()->getBaseUrl(true), 'og:site_name');
    Yii::app()->clientScript->registerMetaTag($motor->descricao, 'og:description');
    $title = array("Motores | ", MotorAnuncio::nomeAnuncio($motor));
...
<?php
    ...
    $anunciante = Usuarios::model()->findByPk($motor->usuarios_id);
...
<?php if (Yii::app()->user->id == $motor->usuarios_id): ?>
    ...
    <section id="estatisticas">
        ...
        <div class="estatisticas-line">
            <div class="container">
                <?php if ($motor->data_registro != null) : ?>
                    <span class="estatisticas-title"><?php echo 'Data de registro: <b class="bold-blue">' . Utils::formatDateTimeToView($motor->data_registro) . '</b>'; ?></span>
                <?php endif; ?>
        ...
        <div class="estatisticas-box">
            <div class="container">
                <div class="estatisticas-cell">
                    ...
                    <span class="cell-result"><?php echo MotorAnuncio::totalizarMensagens(Yii::app()->user->id, $motor->id);?></span>
                </div>
                <div class="estatisticas-cell">
                    <span class="cell-title">Cliques:</span>
                    <span class="cell-result"><?php echo MotorAnuncio::totalizarCliques(Yii::app()->user->id, $motor->id);?></span>
                </div>

                <div class="estatisticas-cell">
                    <span class="cell-title">Ver Telefone:</span>
                    <span class="cell-result"><?php echo MotorAnuncio::totalizarVerTelefone(Yii::app()->user->id, $motor->id);?></span>
                </div>
                ...
                <div class="estatisticas-cell">
                    <a class="bt-action" href="<?php echo Yii::app()->createUrl('motorAnuncio/update', array('id' => $motor->id)); ?>">Editar</a>
                </div>
            ...
            <div class="box-deemb1 pure-u-1">
                ...
                <div class="quadro-l1-deemb1 pure-u-1">
                    <span class="text-top-deemb pure-u-3-5 pure-u-sm-5-5 pure-u-md-5-5" style="margin-top:40px !important; text-align:left;">
                        ...
                        <a href="/">Home</a> &gt; <a href="/motores">Motores</a> &gt; <a href="/motores/<?php echo $motor->motorFabricantes->slug; ?>"><?php echo $motor->motorFabricantes->titulo; ?></a> &gt; <a href="/motores/<?php echo $motor->motorFabricantes->slug . '/' . $motor->motorTipos->slug; ?>"><?php echo $motor->motorTipos->titulo; ?></a> &gt; <a href="#"><?php echo $motor->potencia; ?></a>
                    </span>
                ...
                <div class="quadro-l1-deemb3 pure-u-1">
                    ...
                    <div class="quadro-l1-deemb2">
                        ...
                        <?php
                            $fabricante = $motor->motorFabricantes->titulo;
                            $tipo = $motor->motorTipos->titulo;
                            $potencia = $motor->potencia;

                            $editouFab = $motor->motorFabricantes->status = 0 ? true : false;
                            $editouTipo = $motor->motorTipos->status = 0 ? true : false;
                        ?>

                        <h1 class="title-emb-deemb pure-u-6-12 pure-u-sm-12-12 pure-u-md-12-12">
                            <span style="<?php if($editouFab){echo 'color: red;';} ?>"><?php echo $fabricante;?></span>&nbsp;<span style="<?php if($editouTipo){echo 'color: red;';} ?>"><?php echo $tipo; ?></span>&nbsp;<span><?php echo $potencia; ?></span>
                        </h1>
                ...
                <div class="quadro-l1-deemb5 pure-u-3-5 pure-u-sm-1 pure-u-md-1">
                    ...
                    <div class="pure-u-4-5 slider-principal">
                        <div id="div-deemb1">
                            ...
                            <?php if(count($motor->motorImagens) > 0): ?>
                ...
                <div id="limita-form" class="pure-u-2-5 pure-u-sm-5-5">
                    ...
                    <div id="mini-info">
                        ...
                        <div class="quadro-deemb">
                            ...
                            <?php
                                if (empty($motor->valor) || $motor->valor == '0.00') {
                                    echo 'R$ não informado';
                                } else {
                                    echo 'R$ ' . Utils::formataValorView((float) $motor->valor);
                                }
                            ?>
                            </h2>
                            ...
                            <form id="form-contato" method="POST">
                                ...
                                <input type="hidden" id="id_motor" name="ContatosMotor[motor_anuncio_id]" value="<?php echo $motor->id; ?>"/>
                                <input type="hidden" id="email_dest" name="ContatosMotor[email_dest]" value="<?php echo $motor->usuarios->email; ?>"/>
	                            <div class="campo">
	                                <label>Nome: </label>
	                                <input id="nome_principal" name="ContatosMotor[nome_rem]" class="campo-msg-principal" value="<?php echo $nome; ?>" type="text" required="required">
	                            </div>
	                            <div class="campo">
	                                <label>E-mail: </label>
	                            ...
	                            <div class="campo">
	                                ...
	                                <input id="celular_principal" name="ContatosMotor[telefone_rem]" class="campo-msg-principal" value="<?php echo $celular; ?>" type="tel" autocomplete="off">
	                            </div>
                    ...
                    <div class="limita-conteudo pure-u-1">
                        <div class="tab-content pure-u-1 pure-u-sm-5-5">
                            <div id="descricao" class="tab active">
                                ...
                                <?php if($motor->descricao != ""): ?>
                                    <p><?php echo $motor->descricao; ?></p>
                                <?php endif; ?>
                                ...
                                <div class="quadro-l1-deemb6">
                                    ...
                                    <?php if ($motor->motorTipos->titulo != ""): ?>
                                        ...
                                        <div class="quadro-l1-deemb6b">
                                            ...
                                            <div class="div-info-quadros-view3" style="width: 140px;">
                                                <span class="text-dnmc-deemb1">
                                                    <?php echo $motor->motorTipos->titulo; ?>
                                                </span>
                                            </div>
                                        </div>
                                    <?php endif; ?>

                                    <?php if ($motor->estado != null): ?>
                                        <div class="quadro-l1-deemb6b">
                                            <div class="div-info-quadros-view3" style="width: 140px;">
                                            ...
                                            <div class="div-info-quadros-view4" style="width: 160px;">
                                                <span class="text-dnmc-deemb1">
                                                    <?php echo $motor->estado = ('U') ? 'Usado' : 'Novo'; ?>
                                                </span>
                                            </div>
                                        </div>
                                    <?php endif; ?>

                                    <?php if ($motor->ano != null): ?>
                                        <div class="quadro-l1-deemb6b">
                                    ...
                                    <?php if($motor->potencia != null): ?>
                                        <div class="quadro-l1-deemb6b">
                                            ...
                                            <div class="div-info-quadros-view3" style="width: 140px;">
                                                <span class="text-dnmc-deemb1">
                                                    <?php echo $motor->potencia; ?>
                                                </span>
                                            </div>
                                        </div>
                                    <?php endif; ?>

                                    <?php if ($motor->cilindrada != null): ?>
                                    ...
                                    <?php if ($motor->sistema_partida != null): ?>
                                        ...
                                        <div class="quadro-l1-deemb6b">
                                            ...
                                            <div class="div-info-quadros-view3" style="width: 140px;">
                                                <span class="text-dnmc-deemb1">
                                                    <?php echo $motor->sistema_partida; ?>
                                                </span>
                                            </div>
                                        </div>
                                    ...
                                    <?php if ($motor->comprimento_eixo != null): ?>
                                        ...
                                        <div class="quadro-l1-deemb6b">
                                            ...
                                            <div class="div-info-quadros-view3" style="width: 140px;">
                                                <span class="text-dnmc-deemb1">
                                                    <?php echo $motor->comprimento_eixo; ?>
                                                </span>
                                            </div>
                                        </div>
                                    ...
                                    <?php if ($motor->relacao_engrenagens != null): ?>
                                        ...
                                        <div class="quadro-l1-deemb6b">
                                            ...
                                            <div class="div-info-quadros-view3" style="width: 140px;">
                                                <span class="text-dnmc-deemb1">
                                                    <?php echo $motor->relacao_engrenagens; ?>
                                                </span>
                                            </div>
                                        </div>
